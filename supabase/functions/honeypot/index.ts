...
const corsHeaders = {
  ...
  'Access-Control-Allow-Headers': 'authorization, x-client-info, apikey, content-type, x-api-key, accept, origin, x-requested-with, user-agent, cache-control, keep-alive, host, connection, upgrade, pragma, dnt, referer',
